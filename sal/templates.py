...
# %% auto 0
__all__ = ['render', 'TemplateRenderer', 'TemplateLoader', 'MissingTemplate', 'InMemoryTemplateLoader',
           'FrontMatterInMemoryTemplateLoader', 'Renderer']
...
class FrontMatterInMemoryTemplateLoader(InMemoryTemplateLoader):
